...
export default function ProfileModal(props) {
 ...
 <Modal overflow={props.overflow} show={props.show} onHide={props.ModalClose} size={'lg'}>
                <Modal.Header>
                  ...
                  <FlexboxGrid align="space-between">
...

{
    props.doctorReview.flat().map(entry => String(entry.doctor_id) === DoctorID.flat().map(entry => 
        entry)[0] ? (
            <FlexboxGrid align="space-around">
                <FlexboxGrid.Item>
                    <Avatar alt={'patient image'} src={'https://source.unsplash.com/80x80/?dentist'} circle={true} size={'sm'} classPrefix={'profileModal__patientImage'} />
                </FlexboxGrid.Item>
...
<div className="footer-flex" style={{marginTop:'300px'}}>
