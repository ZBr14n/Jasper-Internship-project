...
import {Progress, Button, FlexboxGrid, Alert} from 'rsuite'
import { ProgressContext } from '../../Context/ProgressContext'
import PlacesAutocomplete from '../GooglePlaces/PlacesAutoComplete'
import { LocationContext } from '../../Context/LocationContext'
import "../../scss/part6.scss"

export default function Part6() {
    // keep track of the user's progress throughout the survey and w
    ...
    const StoreAndDisplay = () => {
        sessionStorage.setItem('part6', location)
        return location
    }
    ...
    const handleContinue = () => {
        ...
        // wait 5 seconds for it to send to server and then redirect the page
        Alert.success('Thank you for completing the quiz!', 4000)
        setTimeout(()=>{
            window.location.replace(window.location.origin + '/dir')
        },5000)
    }
  ...
  const handleSubmit = () => {
    ...
    fetch(window.location.origin+'/wp-json/user-survey-responses/v1/store',{
        method: 'POST',
        mode: "same-origin",
    ...
    return (
        <div className="page">
            ...
            <FlexboxGrid justify="center">
                <FlexboxGrid.Item>
                    <h6 className={'part6-header'}>Where are you located?</h6>
                    <PlacesAutocomplete />
                </FlexboxGrid.Item>
            </FlexboxGrid>
            ...
            <br/>
            <FlexboxGrid justify="center">
            <h6 className={'part6-header'}>
            <svg width="29" height="35" viewBox="0 0 29 35" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1 11.4999C1 16.5 9.33333 29.8333 14 33.5C18.5 30.0002 27.5 15.8999 27.5 11.4999C27.5 5.99994 22.5 1 14.5 1C6.4601 1 1 6 1 11.4999Z" fill="#151515" stroke="#151515" stroke-width="2"/>
<circle cx="14" cy="13.5" r="4" fill="#FCFCFC" stroke="#FCFCFC" stroke-width="2"/>
</svg>{' '}
                You are here</h6>
                <br />
            </FlexboxGrid>
            ...
            <FlexboxGrid justify="center">
                <p className={'part6-location'}>{StoreAndDisplay()}</p>
            </FlexboxGrid>
            ...
            <FlexboxGrid justify="center">
                <FlexboxGrid.Item colspan={4}>
                    {/* <Link to={window.location.origin + '/dir/'}>
                        <Button appearance="primary" onClick={handleContinue}>Skip</Button>
                    </Link> */}
                    
                    <Button classPrefix={'btn-skip'} onClick={handleContinue}>Skip</Button>
