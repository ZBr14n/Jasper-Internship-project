 ...
 * @wordpress-plugin
 *
 * Plugin Name:     Embedded React App in WP - survey
...
require 'app/src/user_survey_responses.php';

 
 
function md_react_app_shortcode_survey() {
...
add_shortcode(
	'md-react-app_survey',
	'md_react_app_shortcode_survey'
);

/**
 * Enqueues styles and js compiled for plugin.
 */
function md_react_app_enqueue_assets_survey() {
...
add_action( 'wp_enqueue_scripts', 'md_react_app_enqueue_assets_survey' );
