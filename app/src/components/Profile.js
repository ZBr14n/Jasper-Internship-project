...
export default function Profile(props) {
    ...
    const ModalOpen = (id,event) => {                
        ...
        // fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${DoctorFullAdress.flat().map(entry => entry !== null ? entry : null).join('')}&key=AIzaSyD9ORuSLvfipK-tVUfSC0fNvomDAjoXVlo`)
        //     .then(res => res.json())
        //     .then(data => {
